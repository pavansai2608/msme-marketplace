  ...
  */
  ...
  return (
    <>
          ...
          >
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontWeight: 700, fontSize: '0.9rem', color: 'white' }}>
                {displayName || (loading ? 'Checking...' : 'Sign In')}
              </div>
            </div>
            <div
              style={{
      ...
      >
        <div
          style={{ background: '#000000', padding: '32px', color: 'white', position: 'relative' }}
        >
          <button
            onClick={(e) => {
              e.stopPropagation()
          ...
          <div style={{ fontSize: '1.25rem', fontWeight: 800, fontFamily: "'Sora', sans-serif" }}>
        ...
        >
          ...
          >
            ...
            >
              Manage your shop and fulfill orders with our AI dashboard.
            </p>
            <button
              onClick={() => {
                setSidebarOpen(false)
        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{
                width: '100%',
                background: gettingLocation ? '#f1f5f9' : '#F3F4F6',
                color: gettingLocation ? '#94a3b8' : '#0F172A',
                border: `1.5px solid ${gettingLocation ? '#e2e8f0' : '#0F172A'}`,
                padding: '14px',
                borderRadius: '12px',
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <FaCrosshairs color={gettingLocation ? '#94a3b8' : '#0F172A'} />{' '}
              {gettingLocation ? 'Locating via GPS...' : 'Auto-detect my location'}
            </button>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <select
                ...
                onChange={(e) => {
                  setSelectedStateForLoc(e.target.value)
                }}
                style={{
                  width: '100%',
                  padding: '12px 16px',
                ...
                >
                  {apiDistricts.map((dist) => (
                    <button
                      ...
                      style={{
                        padding: '12px',
                        background: district === dist ? 'var(--primary)' : '#f8fafc',
                        color: district === dist ? 'white' : 'var(--text-main)',
                        border: district === dist ? 'none' : '1px solid var(--border)',
                        borderRadius: '8px',
                        cursor: 'pointer',
                        fontWeight: 600,
                        transition: 'all 0.2s',
