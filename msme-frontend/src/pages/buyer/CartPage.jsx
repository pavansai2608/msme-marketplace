    ...
    <div style={{ background: 'var(--background)', minHeight: '100vh' }}>
      ...
      >
        <div>
          ...
          >
            {cart?.items?.length || 0} exquisite items ready for checkout
          </p>
        </div>
        {!isEmpty && (
          <button
      ...
      <div
        style={{
          ...
          padding: '0 40px',
          display: 'grid',
          gridTemplateColumns: isEmpty ? '1fr' : '1fr 400px',
          gap: '60px',
        }}
      >
        {/* Cart Items */}
        <div>
          {isEmpty ? (
            ...
            >
              ...
              <h2 style={{ fontSize: '1.75rem', color: '#111827', marginBottom: '12px' }}>
                Your bag is empty
              </h2>
              ...
              <button
                ...
                style={{ padding: '18px 48px', borderRadius: '16px' }}
                onClick={() => navigate('/buyer')}
              >
                Start Exploring
              </button>
                        ...
                        >
                          ...
                          <button
                            ...
                            style={{
                              ...
                              justifyContent: 'center',
                              background:
                                item.quantity >= availableStock ? 'var(--border-soft)' : 'white',
                              border: '1px solid var(--border)',
                              borderRadius: '8px',
                              cursor: item.quantity >= availableStock ? 'not-allowed' : 'pointer',
                              fontWeight: 800,
                              fontSize: '1rem',
                              color: item.quantity >= availableStock ? '#D1D5DB' : 'inherit',
                              transition: 'all 0.2s',
                            }}
                            onMouseEnter={(e) =>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: '#059669', fontWeight: 900, fontSize: '0.75rem' }}>
                    FREE
                  </span>
                </div>
              </div>
