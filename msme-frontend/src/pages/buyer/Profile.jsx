    ...
    <div style={{ background: 'var(--background)', minHeight: '100vh', paddingBottom: '60px' }}>
      ...
      <div style={{ maxWidth: '850px', margin: '60px auto', padding: '0 20px' }}>
        ...
        >
          ...
          {isEditing && (
            <div
              style={{ padding: '32px', background: '#F9FAFB', borderBottom: '1px solid #F3F4F6' }}
            >
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '24px' }}>
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Max size 2MB. Preferred: Square (1:1)
                  </p>
                </div>
              ...
              {newAvatar && newAvatar.startsWith('data:image') && (
                ...
                >
                  ...
                  />
                  <div style={{ fontWeight: 800, fontSize: '0.7rem', color: '#000' }}>
                    NEW PREVIEW
                  </div>
                </div>
              )}
          ...
          <div
            style={{ padding: '40px 40px', display: 'flex', flexDirection: 'column', gap: '32px' }}
          >
