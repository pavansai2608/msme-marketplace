      ...
      <div style={{ maxWidth: '1000px', margin: '40px auto', padding: '0 40px' }}>
        ...
        {orders.length === 0 ? (
          ...
          >
            ...
            <h2 style={{ fontSize: '1.5rem', color: '#111827', marginBottom: '8px' }}>
              No orders yet
            </h2>
            ...
            <button
              ...
              style={{ padding: '14px 32px', borderRadius: '12px', fontSize: '0.85rem' }}
              onClick={() => navigate('/buyer')}
            >
              Start Shopping
            </button>
                ...
                >
                  <div style={{ display: 'flex', gap: '40px' }}>
                    <div>
                      ...
                      <div
                        style={{ fontWeight: 800, color: 'var(--text-main)', fontSize: '0.85rem' }}
                      >
                  ...
                  {order.products.map((item, i) => (
                    <div
                      ...
                      style={{
                        ...
                        gap: '32px',
                        paddingBottom: '32px',
                        marginBottom: i < order.products.length - 1 ? '32px' : 0,
                        borderBottom:
                    ...
                    >
                      ...
                      <div style={{ flex: 1, padding: '8px 0' }}>
                        ...
                        >
                          ₹
                          {(
                            (item.price || item.product?.price || 5999) * item.quantity
                          ).toLocaleString()}
                        </div>
                      </div>
                    </div>
                          ...
                          {i < statusSteps.length - 1 && (
                            <div
                              style={{
                                ...
                                width: '100%',
                                height: '2px',
                                background: isDone && i < currentIdx ? '#000' : '#E5E7EB',
                                zIndex: 0,
                              }}
                            ></div>
                          )}
