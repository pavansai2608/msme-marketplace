      ...
      >
        ...
        <div className="animate-fade-in">
          ...
          {step === 1 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              <h2 style={{ fontSize: '1.6rem', color: '#111827', fontWeight: 800 }}>
                Review Order
              </h2>
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: '#111827', fontWeight: 700 }}>{address.pincode}</span>
                  <br />
                  {address.phone}
                </div>
              </div>
                ...
                {cart?.items?.map((item, i) => (
                  <div key={i} style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        Size: {item.size} • Quantitity: {item.quantity}
                      </div>
                    </div>
              ...
              <button
                className="btn-primary"
                style={{ padding: '24px', borderRadius: '16px', fontSize: '1.1rem' }}
                onClick={() => setStep(2)}
              >
                CONTINUE TO PAYMENT
              </button>
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: '50%',
                        border: '2px solid',
                        borderColor: paymentMethod === m.id ? '#000' : '#D1D5DB',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        background: 'white',
        ...
        <div>
          ...
          >
            ...
            >
              <span style={{ fontWeight: 800, fontSize: '1.25rem', color: '#111827' }}>
                TOTAL DUE
              </span>
              <span style={{ fontWeight: 800, fontSize: '1.6rem', color: '#111827' }}>
                ₹{subtotal.toLocaleString()}
              </span>
            </div>
