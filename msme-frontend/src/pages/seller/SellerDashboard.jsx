...
const CATEGORY_SIZES = [
  // ── PHONES & ELECTRONICS (Colors) ──────────────────────────────────────────
  {
    ...
    label: 'Color Variant',
    sizes: ['Black', 'White', 'Blue', 'Green', 'Gold', 'Silver', 'Red', 'Pink'],
  },
  ...
  // ── FOOD STAPLES (Rice, Dal, Atta, Grains) ──────────────────────────────────
  {
    ...
    label: 'Weight',
    sizes: ['500g', '1kg', '2kg', '5kg', '10kg', '25kg'],
  },
  ...
  // ── OILS & GHEE ─────────────────────────────────────────────────────────────
  {
    ...
    label: 'Volume / Weight',
    sizes: ['250ml', '500ml', '1L', '2L', '5L', '15L'],
  },
  ...
  // ── COSMETICS & BEAUTY ──────────────────────────────────────────────────────
  {
    ...
    label: 'Size (ml/g)',
    sizes: ['25ml', '50ml', '100ml', '200ml', '500ml'],
  },
  ...
  // ── FURNITURE ───────────────────────────────────────────────────────────────
  {
    ...
    label: 'Size',
    sizes: ['Single', 'Small', 'Medium', 'Large', 'King', 'Queen'],
  },
  ...
  // ── AGRICULTURE INPUTS ──────────────────────────────────────────────────────
  {
    ...
    label: 'Weight / Volume',
    sizes: ['500g', '1kg', '5kg', '10kg', '25kg', '50kg'],
  },
  ...
  // ── SPORTS & FITNESS ────────────────────────────────────────────────────────
  {
    ...
    label: 'Size / Units',
    sizes: ['Small', 'Medium', 'Large', 'XL', 'Free Size'],
  },
  ...
  // ── BABY & KIDS ─────────────────────────────────────────────────────────────
  {
    ...
    label: 'Age / Size',
    sizes: ['0-6m', '6-12m', '1-2yr', '2-3yr', '3-5yr', '5-8yr', '8-12yr'],
  },
  ...
  // ── PUJA & RELIGIOUS ────────────────────────────────────────────────────────
  {
    ...
    label: 'Pack Size',
    sizes: ['Small', 'Medium', 'Large', 'Box of 10', 'Box of 25'],
  },
]
  ...
  const loanProducts = [
    {
      ...
      amount: '₹10,00,000',
      interest: '8.5% p.a.',
      link: 'https://sbi.co.in/web/business/msme/loans',
    },
    {
      id: 2,
      bank: 'HDFC Business Growth',
      amount: '₹25,00,000',
      interest: '10.2% p.a.',
    ...
    {
      id: 3,
      bank: 'SIDBI Micro-finance',
      amount: '₹5,00,000',
      interest: '7.0% p.a.',
      link: 'https://www.sidbi.in/en/products/direct-lending',
    },
  ]
    ...
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
      <header style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <h1 style={{ fontSize: '1.75rem', fontWeight: 800, fontFamily: "'Sora', sans-serif" }}>
              Financial Institution Gateway
            </h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
              Pre-approved micro-loans and credit facilities based on your marketplace performance.
            </p>
          </div>
          <button
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ margin: 0, color: 'var(--text-muted)' }}>
              Maintain consistent sales and order volume to unlock pre-approved credit facilities
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '1.1rem', fontWeight: 900, color: 'var(--text-main)' }}>
              {stats.totalSales > 0 ? 'ACTIVE' : 'PENDING'}
            </div>
          </div>
        </div>
      </div>
        ...
        {loanProducts.map((lp) => (
          ...
          >
            ...
            <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '20px' }}>
              Up to <strong style={{ color: 'var(--text-main)' }}>{lp.amount}</strong>
            </div>
...
function SchemesTab() {
  ...
  const filtered = schemes.filter((s) => {
    ...
    const matchesDistrict =
      districtFilter === 'All India' || s.district === districtFilter || s.district === 'All India'
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
      <header style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
          Central & State government benefits for your business category.
        </p>
        ...
        {successScheme && (
          ...
          >
            <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <FaCheck size={14} /> Application intent for "{successScheme}" recorded! Our district
              advisor will contact you soon.
            </span>
            <button
              onClick={() => setSuccessScheme(null)}
              style={{
                background: 'none',
                border: 'none',
                cursor: 'pointer',
        ...
        <div style={{ display: 'flex', gap: '20px', marginTop: '32px' }}>
          <div style={{ position: 'relative', flex: 1 }}>
            <FaSearch
              style={{ position: 'absolute', left: '16px', top: '15px', color: '#94a3b8' }}
            />
            <input
              type="text"
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem' }}>
              No schemes found matching your filters. Try selecting 'All Categories'.
            </p>
            <button
              className="btn-outline"
              onClick={() => {
                setCategoryFilter('All Categories')
                setDistrictFilter('All India')
              }}
          ...
          filtered.map((s, i) => (
            ...
            >
              ...
              <h4 style={{ margin: '0 0 8px 0', fontSize: '1.15rem', fontWeight: 800 }}>
                {s.title}
              </h4>
              <p
                style={{
              ...
              <div
                style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '16px' }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  justifyContent: 'center',
                  gap: '8px',
                  background: successScheme === s.title ? '#f0fdf4' : undefined,
                  color: successScheme === s.title ? '#15803d' : undefined,
                  borderColor: successScheme === s.title ? '#bbf7d0' : undefined,
                }}
              ...
              >
                ...
                ) : successScheme === s.title ? (
                  <>
                    <FaCheck /> Applied Successfully
                  </>
                ) : (
                  'Apply Now'
                )}
...
function LogisticsTab({ orders, onRefresh }) {
  ...
  const stats = {
    ...
    dispatched:
      orders?.filter((o) => o.status === 'Dispatched' || o.status === 'Shipped').length || 0,
    ...
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
          ...
          >
            ...
            >
              ...
              <div style={{ color: 'var(--text-muted)', marginTop: '4px' }}>
                {assignModal.buyer?.name} · ₹{assignModal.totalAmount?.toLocaleString()}
              </div>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>
                {assignModal.shippingAddress?.street}, {assignModal.shippingAddress?.city},{' '}
                {assignModal.shippingAddress?.state} – {assignModal.shippingAddress?.pincode}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={assignAWB}
                  onChange={(e) => setAssignAWB(e.target.value.toUpperCase())}
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            Manage shipments, assign carriers, and track orders in real-time.
          </p>
        </div>
        <div
          style={{
        ...
        {[
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '12px',
              background: k.bg,
              border: `1.2px solid ${k.border}`,
            }}
          >
            <div style={{ fontSize: '1.6rem', fontWeight: 900, color: k.color, lineHeight: 1 }}>
              {k.value}
            </div>
            <div
              style={{
      ...
      <div
        style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '32px', marginBottom: '40px' }}
      >
        {/* Real Tracking - Full Width */}
        <div
          className="glass-card"
          style={{ padding: '28px', background: 'white', border: '1px solid var(--border-soft)' }}
        >
                  ...
                  <div style={{ animation: 'fadeIn 0.3s ease' }}>
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontWeight: 800, fontSize: '1.05rem', marginTop: '2px' }}>
                          {o.logisticsProvider || 'Unknown Carrier'}
                        </div>
                        <div
                          style={{
                            fontSize: '0.78rem',
                        ...
                        >
                          {o.buyer?.name} · ₹{o.totalAmount?.toLocaleString()}
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <span
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: '10px',
                              borderRadius: '50%',
                              background: i === 0 ? 'var(--secondary)' : '#cbd5e1',
            ...
            : !trackError && (
                <div style={{ textAlign: 'center', padding: '32px', color: 'var(--text-muted)' }}>
                  ...
                  <p style={{ fontSize: '0.88rem' }}>
                    Enter an AWB number to see real-time tracking from your orders.
                  </p>
                </div>
              )}
        </div>
      ...
      <div
        className="glass-card"
        style={{ background: 'white', border: '1px solid var(--border-soft)', overflow: 'hidden' }}
      >
        <div
          style={{
            padding: '24px 28px',
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <div style={{ fontWeight: 600, fontSize: '0.88rem' }}>
                        {o.shippingAddress?.name || o.buyer?.name || 'Customer'}
                      </div>
                    ...
                    >
                      {o.items?.length || o.products?.length || 0} item(s)
                    </td>
                    <td style={{ padding: '14px 16px', fontWeight: 700, fontSize: '0.92rem' }}>
                    ...
                    >
                      {o.logisticsProvider ? (
                        <span>
                          {carrierLogos[o.logisticsProvider] || '📦'} {o.logisticsProvider}
                        </span>
                      ) : (
                    ...
                    <td
                      style={{
                        ...
                        fontSize: '0.8rem',
                        fontFamily: 'monospace',
                        color: o.trackingId ? 'var(--primary)' : '#cbd5e1',
                        cursor: o.trackingId ? 'pointer' : 'default',
                        fontWeight: 600,
                      }}
                      onClick={() => {
                        if (o.trackingId) {
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      {o.status !== 'Delivered' && o.status !== 'Cancelled' && (
                        <button
                          onClick={() => {
                            setAssignModal(o)
                            setAssignCarrier(o.logisticsProvider || 'BlueDart Express')
                            setAssignAWB(o.trackingId || '')
                            setAssignStatus(o.status === 'Ordered' ? 'Dispatched' : o.status)
                          }}
                          style={{
                            padding: '6px 14px',
                            borderRadius: '8px',
...
function AnalyticsTab({ forecastData, globalRecommendations, onRefresh }) {
  ...
  const recs = globalRecommendations || [
    'Keep monitoring your sales trends to build a more accurate AI baseline.',
  ]
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '6px' }}>
            Demand forecast from your order history.
          </p>
        </div>
        <button
          className="btn-outline"
      ...
      >
        ...
        >
          {recs.map((r, i) => (
            <li key={i} style={{ color: 'var(--text-main)', fontWeight: 600, fontSize: '0.8rem' }}>
              {r}
            </li>
          ))}
        </ul>
          ...
          {items.length === 0 ? (
            ...
            >
              <p style={{ color: 'var(--text-muted)', margin: 0 }}>
                Insufficient data for AI modeling. Start listing and selling to activate insights.
              </p>
            </div>
          ) : (
            items.map((f) => (
              <div
                ...
                style={{
                  ...
                  borderTop: '6px solid',
                  borderTopColor:
                    f.inventory_alert?.status === 'understock'
                      ? '#ef4444'
                      : f.inventory_alert?.status === 'overstock'
                        ? '#f59e0b'
                        : '#22c55e',
                  background: 'white',
                }}
              >
                ...
                >
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div
                      style={{
                        fontWeight: 900,
                        color: f.inventory_alert?.status === 'understock' ? '#ef4444' : '#15803d',
                      }}
                    >
                      {(f.inventory_alert?.status || 'optimal').toUpperCase()}
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: '1.1rem', fontWeight: 900 }}>
                      {f.inventory_alert?.recommended_stock || 0} units
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    "{f.inventory_alert?.action || 'No action needed.'}"
                  </div>
                </div>
                ...
                <div style={{ marginTop: '32px', width: '100%', height: 180 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={f.forecast}>
                      ...
                      <Tooltip
                        contentStyle={{ borderRadius: '12px', border: 'none', fontSize: '0.8rem' }}
                      />
                      <Bar dataKey="quantity" name="Predicted Demand" radius={[4, 4, 0, 0]}>
                        {(f.forecast || []).map((entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={index === 2 ? 'var(--secondary)' : 'var(--primary)'}
                          />
                        ))}
                      </Bar>
                    </BarChart>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ padding: '0 32px 48px', gap: '12px', display: 'flex', alignItems: 'center' }}
      >
        <div
          style={{
            background: 'var(--text-main)',
      ...
      <nav className="sidebar-nav">
        {tabs.map((t) => (
          ...
          >
            <span style={{ opacity: activeTab === t.id ? 1 : 0.6, fontSize: '1.1rem' }}>
              {t.icon}
            </span>{' '}
            {t.label}
          </div>
...
function OverviewTab({ user, stats, orders, products, onRefresh }) {
  ...
  const lowStockNum =
    products?.filter((p) => p.totalStock < (p.lowStockThreshold || 5))?.length || 0
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 500 }}>
            ...
            <strong style={{ color: 'var(--text-main)' }}>{user.businessName}</strong>
          </p>
        </div>
        <div
          style={{
      ...
      >
        {[
          ...
          },
          {
            ...
            sub: `${pendingDispNum} pending dispatch`,
          },
          {
            icon: <InventoryIcon />,
            bg: 'var(--text-main)',
            ...
            sub: `${lowStockNum} items low stock`,
          },
        ].map((c, i) => (
          <div
            key={i}
            ...
            >
              ...
              <div
                style={{
                  fontSize: '0.65rem',
                  fontWeight: 700,
                  color: i === 0 ? 'var(--secondary)' : '#64748B',
                }}
              >
                {c.sub}
              </div>
        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '4px' }}>
              ...
              <strong>
                {stats.month || new Date().toLocaleString('default', { month: 'long' })}{' '}
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--primary)' }}>
              ₹{(chartData.reduce((acc, curr) => acc + curr.revenue, 0) || 0).toLocaleString()}
            </div>
          </div>
        </div>
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    ...
                    >
                      {order.buyer?.name ? order.buyer.name.charAt(0) : '?'}
                    </div>
                    <div>
                ...
                >
                  {order.products
                    .filter((p) => p.seller === user._id || p.seller === user.id)
                    .map((item) => (
                      <div
                        key={item._id}
                        style={{
    ...
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            Manage your high-end product collection and stock levels.
          </p>
        </div>
      ...
      {products.length === 0 ? (
        <div
          className="glass-card"
          style={{ padding: '100px', textAlign: 'center', border: '1px solid var(--border-soft)' }}
        >
          ...
          <p style={{ color: 'var(--text-muted)' }}>
            Start your boutique by adding your first product.
          </p>
        </div>
      ) : (
        <div
        ...
        >
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              ...
              >
                {['Product Details', 'Price', 'Status', 'Stock Allocation', 'Actions'].map(
                  (h, i) => (
                    <th
                      key={i}
                      style={{
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '16px 24px' }}>
                      <div
                        style={{ fontWeight: 800, fontSize: '0.9rem', color: 'var(--text-main)' }}
                      >
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '0 20px' }}>
      <header style={{ marginBottom: '48px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <h1 style={{ fontSize: '2.5rem', fontWeight: 800, fontFamily: "'Sora', sans-serif" }}>
              Customer Orders
            </h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '1rem' }}>
              Manage fulfillments and track shipping status for your boutique sales.
            </p>
          </div>
          <button
            className="btn-outline"
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                >
                  {['Ordered', 'Packed', 'Dispatched', 'Shipped', 'Delivered', 'Cancelled'].map(
                    (s) => (
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: '#4338ca', fontWeight: 700 }}>
                    Shiprocket AWB:{' '}
                    <span style={{ fontFamily: 'monospace' }}>{order.trackingId}</span>
                  </span>
                </div>
                <div style={{ fontSize: '0.75rem', color: '#6366f1', fontWeight: 800 }}>
                    ...
                    .map((p, idx) => (
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            {p.size} <span style={{ margin: '0 8px', color: '#CBD5E1' }}>•</span>{' '}
                            Qty: {p.quantity}
                          </div>
                        </div>
                        <div style={{ fontWeight: 800, fontSize: '1.1rem' }}>
                          ₹{((p.price || p.product?.price || 0) * p.quantity).toLocaleString()}
                        </div>
                      </div>
                    ))}
                </div>
                ...
                >
                  ...
                  <div>
                    <strong style={{ display: 'block', marginBottom: '4px' }}>
                      {order.shippingAddress?.name || order.buyer.name}
                    </strong>
...
function AccountTab({
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '0 20px', maxWidth: '1000px' }}>
      <header style={{ marginBottom: '32px' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, fontFamily: "'Sora', sans-serif" }}>
          Hub Settings
        </h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 600 }}>
          Manage your merchant profile and business identity.
        </p>
      </header>

      <div
        className="glass-card"
        style={{ padding: '56px', border: '1px solid var(--border-soft)' }}
      >
        ...
        >
          <div className="input-group" style={{ gridColumn: 'span 2' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                {editProfile ? (
                  <FaTimes color="#94a3b8" />
                ) : (
                  <FaEdit color="var(--secondary)" size={18} />
                )}
              </div>
            </div>
          </div>
        ...
        {editProfile && (
          <button
            className="btn-primary"
            style={{ width: '100%', marginTop: '32px', padding: '18px', borderRadius: '12px' }}
            onClick={onSave}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ marginBottom: '8px', fontWeight: 800, fontSize: '2rem' }}>
      ...
      >
        <div
          ...
          style={{
            ...
            borderRadius: '50%',
            animation: 'spin-seller 1s linear infinite',
            marginBottom: '20px',
          }}
        ></div>
        ...
        <p style={{ color: '#64748b', maxWidth: '300px', lineHeight: 1.5, fontSize: '0.9rem' }}>
          {connectionSlow
            ...
            : 'Accelerating your business environment...'}
        </p>
  ...
  return (
    <div className="seller-layout">
      ...
      <main className="dashboard-content">
        ...
        {activeTab === 'logistics' && (
          <LogisticsTab user={user} orders={orders} onRefresh={refreshAll} />
        )}
