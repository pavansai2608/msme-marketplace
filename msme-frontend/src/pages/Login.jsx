...
export default function Login() {
  ...
  // Validation lives in loginSchema, which mirrors what the API enforces.
  // 'onBlur' rather than 'onChange': flagging a half-typed email on the third
  // keystroke is noise.
  const {
    register,
    handleSubmit,
  ...
  const features = [
    {
      ...
      desc: 'Direct access to verified buyers & markets',
    },
      ...
      <div className="page-wrap" style={S.wrapper}>
        ...
        <div className="left-panel" style={S.left}>
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            <p style={S.desc}>
              An AI-powered smart aggregator connecting Micro, Small & Medium Enterprises with
              buyers, logistics, finance & government schemes.
            </p>
        ...
        <div className="right-panel" style={S.right}>
          ...
          <div
            ...
            style={{
              ...
              gap: 10,
              marginBottom: 24,
              background: 'linear-gradient(135deg,#EEF2FF,#E8EDFB)',
              borderRadius: 16,
              padding: '16px 18px',
            }}
          >
          ...
          <div className="form-card form-wrapper" style={S.formCard}>
            ...
            <h1 className="form-title" style={S.title}>
              Welcome back to
              <br />
              <span style={S.titleBlue}>MSME Platform</span>
            </h1>
                ...
                <div style={S.inputWrap}>
                  <input
                    ...
                    style={{
                      ...S.input,
                      paddingRight: 44,
                      borderColor: errors.password ? '#F44336' : '#E4E8F7',
                    }}
                  />
                  <button
                    style={S.eyeBtn}
